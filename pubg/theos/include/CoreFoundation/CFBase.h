...
#define CF_DONT_USE_FRAMEWORK_INCLUDES
...
#include <AvailabilityMacros.h>
    ...
    #if (defined(__CF_USE_FRAMEWORK_INCLUDES__) || (defined(__MACH__) && !defined(__MWERKS__))) && !defined(CF_DONT_USE_FRAMEWORK_INCLUDES)
	#include <CoreServices/../Frameworks/CarbonCore.framework/Headers/MacTypes.h>
    #elif defined(__MWERKS__)
	#include <MacTypes.h>
    #elif defined(CF_DONT_USE_FRAMEWORK_INCLUDES)
