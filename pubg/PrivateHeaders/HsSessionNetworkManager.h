...
@interface HsSessionNetworkManager : HsSyncListener
{
...
- (void).cxx_destruct;	// IMP=0x0000000101347fec
- (_Bool)isFullSyncEnabled;	// IMP=0x0000000101347ef0
- (void)sync;	// IMP=0x0000000101347c4c
- (id)initWithNetworkManager:(id)arg1 andDataSyncCoordinator:(id)arg2 forSessionController:(id)arg3 andSyncController:(id)arg4;	// IMP=0x00000001013479f0
