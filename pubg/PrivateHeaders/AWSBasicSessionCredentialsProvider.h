...
- (void).cxx_destruct;	// IMP=0x0000000100bcf36c
- (void)invalidateCachedTemporaryCredentials;	// IMP=0x0000000100bcf344
- (id)credentials;	// IMP=0x0000000100bcf2e0
- (id)initWithAccessKey:(id)arg1 secretKey:(id)arg2 sessionToken:(id)arg3;	// IMP=0x0000000100bcf1fc
