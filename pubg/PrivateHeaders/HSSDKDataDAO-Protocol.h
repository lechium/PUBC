...
- (NSMutableArray *)getRemoteNotificationsWithError:(id *)arg1;
- (void)setRemoteNotifications:(NSMutableArray *)arg1 withError:(id *)arg2;
...
- (NSString *)deviceUdidWithError:(id *)arg1;
