...
- (id)protoBuffer;	// IMP=0x00000001008f421c
- (id)initWithBuffer:(id)arg1;	// IMP=0x00000001008f4138
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x00000001008f4074
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x00000001008f4010
