...
- (id)protoBuffer;	// IMP=0x00000001008f4a20
- (id)initWithBuffer:(id)arg1;	// IMP=0x00000001008f493c
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x00000001008f4878
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x00000001008f4814
