...
@interface BLYUserInfoPackage : BLYJceObjectV2
{
    ...
    NSString *jcev2_p_1_o_proceName;	// 16 = 0x10
    NSString *jcev2_p_2_o_deviceId;	// 24 = 0x18
    NSArray *jcev2_p_3_o_list__b0x9i_VOBLYSummaryInfo;	// 32 = 0x20
    NSDictionary *jcev2_p_4_o_valueMap__b0x9i_M09ONSStringONSString;	// 40 = 0x28
}

+ (id)jceType;	// IMP=0x000000010073351c
+ (void)initialize;	// IMP=0x000000010073342c
...
- (void).cxx_destruct;	// IMP=0x00000001007335f8
- (id)init;	// IMP=0x00000001007334a0
