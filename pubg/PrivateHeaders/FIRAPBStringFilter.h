...
- (id)protoBuffer;	// IMP=0x00000001008f4f78
- (id)initWithBuffer:(id)arg1;	// IMP=0x00000001008f4e94
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x00000001008f4dd0
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x00000001008f4d6c
