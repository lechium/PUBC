...
- (id)protoBuffer;	// IMP=0x000000010090c250
- (id)initWithBuffer:(id)arg1;	// IMP=0x000000010090c16c
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x000000010090c0a8
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x000000010090c044
