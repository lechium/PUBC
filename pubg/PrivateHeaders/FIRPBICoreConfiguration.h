...
- (id)protoBuffer;	// IMP=0x000000010090ca54
- (id)initWithBuffer:(id)arg1;	// IMP=0x000000010090c970
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x000000010090c8ac
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x000000010090c848
