...
- (id)protoBuffer;	// IMP=0x00000001008f3214
- (id)initWithBuffer:(id)arg1;	// IMP=0x00000001008f3130
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x00000001008f306c
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x00000001008f3008
