...
- (id)protoBuffer;	// IMP=0x000000010090bcf8
- (id)initWithBuffer:(id)arg1;	// IMP=0x000000010090bc14
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x000000010090bb50
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x000000010090baec
