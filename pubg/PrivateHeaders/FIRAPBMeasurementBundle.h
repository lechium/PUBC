...
- (id)protoBuffer;	// IMP=0x00000001008f3f70
- (id)initWithBuffer:(id)arg1;	// IMP=0x00000001008f3e8c
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x00000001008f3dc8
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x00000001008f3d64
