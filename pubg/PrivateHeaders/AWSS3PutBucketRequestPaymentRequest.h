...
@interface AWSS3PutBucketRequestPaymentRequest : AWSRequest
{
    ...
    AWSS3RequestPaymentConfiguration *_requestPaymentConfiguration;	// 24 = 0x18
}

+ (id)requestPaymentConfigurationJSONTransformer;	// IMP=0x0000000100c0e104
+ (id)JSONKeyPathsByPropertyKey;	// IMP=0x0000000100c0e058
...
- (void).cxx_destruct;	// IMP=0x0000000100c0e1b4
