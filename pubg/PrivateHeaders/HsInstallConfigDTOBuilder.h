...
@interface HsInstallConfigDTOBuilder : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x000000010147f870
- (id)build;	// IMP=0x000000010147f74c
- (void)applyConfig:(id)arg1;	// IMP=0x000000010147f5f8
