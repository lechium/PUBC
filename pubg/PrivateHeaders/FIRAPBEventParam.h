...
- (id)protoBuffer;	// IMP=0x00000001008f376c
- (id)initWithBuffer:(id)arg1;	// IMP=0x00000001008f3688
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x00000001008f35c4
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x00000001008f3560
