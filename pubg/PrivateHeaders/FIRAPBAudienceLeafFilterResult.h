...
- (id)protoBuffer;	// IMP=0x00000001008f2cbc
- (id)initWithBuffer:(id)arg1;	// IMP=0x00000001008f2bd8
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x00000001008f2b14
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x00000001008f2ab0
