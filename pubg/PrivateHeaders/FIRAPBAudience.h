...
- (id)protoBuffer;	// IMP=0x00000001008f2a10
- (id)initWithBuffer:(id)arg1;	// IMP=0x00000001008f292c
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x00000001008f2868
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x00000001008f2804
