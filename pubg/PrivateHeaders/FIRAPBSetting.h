...
- (id)protoBuffer;	// IMP=0x00000001008f4ccc
- (id)initWithBuffer:(id)arg1;	// IMP=0x00000001008f4be8
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x00000001008f4b24
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x00000001008f4ac0
