...
- (id)protoBuffer;	// IMP=0x00000001008f44c8
- (id)initWithBuffer:(id)arg1;	// IMP=0x00000001008f43e4
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x00000001008f4320
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x00000001008f42bc
