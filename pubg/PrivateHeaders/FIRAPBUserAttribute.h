...
- (id)protoBuffer;	// IMP=0x00000001008f5224
- (id)initWithBuffer:(id)arg1;	// IMP=0x00000001008f5140
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x00000001008f507c
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x00000001008f5018
