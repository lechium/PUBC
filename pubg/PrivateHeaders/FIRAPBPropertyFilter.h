...
- (id)protoBuffer;	// IMP=0x00000001008f4774
- (id)initWithBuffer:(id)arg1;	// IMP=0x00000001008f4690
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x00000001008f45cc
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x00000001008f4568
