...
- (id)protoBuffer;	// IMP=0x000000010090bfa4
- (id)initWithBuffer:(id)arg1;	// IMP=0x000000010090bec0
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x000000010090bdfc
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x000000010090bd98
