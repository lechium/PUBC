...
@interface AWSS3TopicConfiguration : AWSModel
{
    ...
    NSString *_topicArn;	// 32 = 0x20
}

+ (id)filterJSONTransformer;	// IMP=0x0000000100c130b0
+ (id)JSONKeyPathsByPropertyKey;	// IMP=0x0000000100c12fec
...
- (void).cxx_destruct;	// IMP=0x0000000100c13184
