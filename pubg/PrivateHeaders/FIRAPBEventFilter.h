...
- (id)protoBuffer;	// IMP=0x00000001008f34c0
- (id)initWithBuffer:(id)arg1;	// IMP=0x00000001008f33dc
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x00000001008f3318
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x00000001008f32b4
