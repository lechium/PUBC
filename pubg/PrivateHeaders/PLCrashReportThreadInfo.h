...
- (void)dealloc;	// IMP=0x0000000101581df4
- (id)initWithThreadNumber:(long long)arg1 stackFrames:(id)arg2 crashed:(_Bool)arg3 registers:(id)arg4;	// IMP=0x0000000101581d34
