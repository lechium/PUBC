...
- (id)protoBuffer;	// IMP=0x000000010090c4fc
- (id)initWithBuffer:(id)arg1;	// IMP=0x000000010090c418
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x000000010090c354
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x000000010090c2f0
