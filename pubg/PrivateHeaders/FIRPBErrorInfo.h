...
- (id)protoBuffer;	// IMP=0x000000010090c7a8
- (id)initWithBuffer:(id)arg1;	// IMP=0x000000010090c6c4
- (id)initWithMessageInfo:(CDStruct_e1a27b1c *)arg1;	// IMP=0x000000010090c600
@property(readonly, nonatomic) const char *messageID;
- (void)dealloc;	// IMP=0x000000010090c59c
