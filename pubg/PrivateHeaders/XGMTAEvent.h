...
- (void).cxx_destruct;	// IMP=0x00000001014fbadc
- (id)toJsonString:(_Bool)arg1;	// IMP=0x00000001014fb1c4
- (id)toJsonString;	// IMP=0x00000001014fb1b4
- (int)generateIDX;	// IMP=0x00000001014fb044
- (int)getRandomNumber:(int)arg1 to:(int)arg2;	// IMP=0x00000001014fb008
- (void)encode:(id)arg1;	// IMP=0x00000001014fb004
- (int)getType;	// IMP=0x00000001014faffc
- (id)init;	// IMP=0x00000001014fae94
