...
- (void)dealloc;	// IMP=0x0000000101582220
- (id)initWithExceptionName:(id)arg1 reason:(id)arg2 stackFrames:(id)arg3;	// IMP=0x0000000101582164
- (id)initWithExceptionName:(id)arg1 reason:(id)arg2;	// IMP=0x0000000101582154
